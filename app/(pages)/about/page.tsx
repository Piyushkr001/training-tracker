  ...
  return (
    <section className="min-h-screen px-4 md:px-10 py-8 flex flex-col gap-10">
      ...
      <div className="text-center max-w-3xl mx-auto flex flex-col items-center">
        <h1 className="text-3xl md:text-4xl font-bold text-blue-600 dark:text-blue-400">About Drill Desk</h1>
        <p className="mt-4 text-gray-600 dark:text-gray-300 text-sm md:text-base leading-relaxed">
          Drill Desk is a powerful platform designed to streamline and manage emergency training and drill sessions 
